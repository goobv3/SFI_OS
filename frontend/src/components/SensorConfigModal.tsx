    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="bg-[#1a1c23] border border-gray-700 rounded-xl max-w-md w-full p-6 relative shadow-2xl flex flex-col">
                ...
                <h2 className="text-xl font-bold text-white mb-6">⚙️ Sensor Configuration</h2>
                ...
                <div className="space-y-4 overflow-y-auto max-h-[70vh] pr-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xs text-gray-400 mb-1">Alias (Name)</label>
                    ...
                    <div className="border-t border-gray-700 pt-4 mt-2">
                        <h3 className="text-sm font-semibold text-neon-orange mb-3">Threshold Settings (Alarms)</h3>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs text-red-400 mb-1">Critical High</label>
                            ...
                            <div>
                                <label className="block text-xs text-amber-400 mb-1">Warning High</label>
                            ...
                            <div>
                                <label className="block text-xs text-amber-400 mb-1 mt-2">Warning Low</label>
                            ...
                            <div>
                                <label className="block text-xs text-red-400 mb-1 mt-2">Critical Low</label>
